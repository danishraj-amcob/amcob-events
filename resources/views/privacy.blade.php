...
@section('title', 'Privacy Policy — AMCOB')
@section('seo_description', 'How AMCOB collects, uses, and protects information submitted through www.amcob.org.')
@section('seo_canonical', route('privacy'))
...
<section class="legal-page">
    <div class="wrap legal-wrap">
        ...
        <p>This privacy policy discloses the privacy practices for www.amcob.org. This privacy policy applies
            solely to information collected by this web site. It will notify you of the following:</p>

        <ul>
            <li>What personally identifiable information is collected from you through the web site, how it is
        ...
        <p>You may opt out of any future contacts from us at any time. You can do the following at any time by
            contacting us via the email address or phone number given on our website:</p>
        <ul>
        ...
        <p>Wherever we collect sensitive information (such as credit card data), that information is encrypted
            ...
            bottom of your web browser, or looking for &quot;https&quot; at the beginning of the address of the
            web page.</p>
        ...
        <p>If you feel that we are not abiding by this privacy policy, you should contact us immediately via
            email at: <a href="mailto:info@amcob.org">info (at) amcob.org</a>.</p>
    </div>
</section>
@endsection
